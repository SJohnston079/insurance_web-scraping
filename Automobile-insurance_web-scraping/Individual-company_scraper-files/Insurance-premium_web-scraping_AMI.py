...
def export_auto_dataset(input_indexes):
    ...
    ami_output_df.loc[:,"PolicyStartDate"] = test_auto_data_df.loc[:,"PolicyStartDate"]
...
def ami_auto_scrape(person_i):
    ...
    try:
        ...
        if ami_auto_premium != None and type(ami_auto_premium) != str: # if an actual result is returned
            ...
            ami_output_df.loc[person_i, "AMI_Error_code"] = "Webiste Does Not Quote For This Car Variant/ Person"
        else:
